      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 text-left w-full">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 md:mb-8 leading-tight" data-testid="cta-title">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-start gap-3 md:gap-4">
              <button 
                className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 text-white text-sm md:text-base font-semibold rounded-full hover:opacity-90 transition-colors sm:min-w-[180px] md:min-w-[200px]"
              ...
              <button 
                className="w-full sm:w-auto px-6 md:px-8 py-3 md:py-4 bg-primary text-primary-foreground text-sm md:text-base font-semibold rounded-full hover:bg-primary/90 transition-colors sm:min-w-[180px] md:min-w-[200px]"
