    ...
    variants: {
      variant: {
        ...
        destructive:
          "bg-primary text-primary-foreground border border-primary-border",
        outline:
          "bg-primary text-primary-foreground border border-primary-border shadow-xs active:shadow-none",
        secondary: "bg-primary text-primary-foreground border border-primary-border",
        ghost: "bg-primary text-primary-foreground border border-primary-border",
      },
