...
import { LayoutDashboard, FileCheck, Users, Coins, Settings, LogOut, Search, Bell, AlertTriangle, BookOpen, FileText, BarChart, Briefcase } from "lucide-react";
...
const navigation = [
  ...
  { name: "Keuangan", href: "/admin/financial", icon: Coins },
